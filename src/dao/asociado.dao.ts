...
function mapToAsociado(row: any): Asociado {
  return new AsociadoModel({
    ...
    telefonoContacto: row.telefonoContacto ?? undefined,
    ...
    anosCongregarse: row.anosCongregarse ?? undefined,
    fechaAceptacion: row.fechaAceptacion ?? undefined,
    perteneceJuntaDirectiva: row.perteneceJuntaDirectiva ?? false,
    puestoJuntaDirectiva: row.puestoJuntaDirectiva ?? undefined,
    estado: row.estado,
    ...
    try {
      const row = await prisma.asociado.create({
        data: {
          ...
          anosCongregarse: data.anosCongregarse ?? null,
          fechaAceptacion: data.fechaAceptacion ? new Date(data.fechaAceptacion) : null,
          perteneceJuntaDirectiva: data.perteneceJuntaDirectiva ?? false,
          puestoJuntaDirectiva: data.puestoJuntaDirectiva ?? null,
