...
async function main() {
  ...
  // ── Congregados ───────────────────────────────────────────────────────────
  const congregados = [
    { nombre: 'Ana Lucía Pérez Mora', cedula: '1-1234-5678', fechaIngreso: new Date('2018-03-15'), telefono: '8811-2233', estadoCivil: 'casado', ministerio: 'Alabanza', urlFotoCedula: 'https://placehold.co/200x120?text=Cedula', fechaNacimiento: new Date('1985-06-20'), correo: 'ana.perez@gmail.com', profesion: 'Maestra', direccion: 'Barrio Ángeles, Liberia' },
    { nombre: 'Carlos Alberto Jiménez Bravo', cedula: '2-2345-6789', fechaIngreso: new Date('2019-07-01'), telefono: '8822-3344', estadoCivil: 'soltero', ministerio: 'Jóvenes', urlFotoCedula: 'https://placehold.co/200x120?text=Cedula', fechaNacimiento: new Date('1998-11-05'), correo: 'carlos.jimenez@hotmail.com', profesion: 'Estudiante', direccion: 'Residencial Los Pinos, Cañas' },
    { nombre: 'Laura Patricia González Vega', cedula: '3-3456-7890', fechaIngreso: new Date('2020-01-20'), telefono: '8833-4455', estadoCivil: 'casado', ministerio: 'Niños', urlFotoCedula: 'https://placehold.co/200x120?text=Cedula', fechaNacimiento: new Date('1990-02-14'), correo: 'laura.gonzalez@yahoo.com', profesion: 'Enfermera', direccion: 'Urbanización Palmares, Santa Cruz' },
    { nombre: 'Roberto Emilio Sánchez Fuentes', cedula: '4-4567-8901', fechaIngreso: new Date('2021-05-10'), telefono: '8844-5566', estadoCivil: 'divorciado', ministerio: 'Evangelismo', urlFotoCedula: 'https://placehold.co/200x120?text=Cedula', fechaNacimiento: new Date('1975-08-30'), profesion: 'Mecánico', direccion: 'Guanacaste, Nicoya Centro' },
    { nombre: 'Sofía Isabel Araya Castillo', cedula: '5-5678-9012', fechaIngreso: new Date('2022-09-03'), telefono: '8855-6677', estadoCivil: 'soltero', ministerio: 'Damas', urlFotoCedula: 'https://placehold.co/200x120?text=Cedula', fechaNacimiento: new Date('2001-04-18'), correo: 'sofia.araya@gmail.com', profesion: 'Secretaria', direccion: 'Barrio Las Flores, Bagaces' },
  ];
